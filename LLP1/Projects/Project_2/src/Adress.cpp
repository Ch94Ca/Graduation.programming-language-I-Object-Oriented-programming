...
void Adress::set_zip_code(std::string zip_code)
{
        this->zip_code = zip_code;
...
std::string Adress::get_zip_code()
{
        return zip_code;

} // end get_zip_code

std::string Adress::get_adress_string()
{
        std::stringstream string;

        string << "Rua:    " << street << " N. " << number << std::endl <<
                "Bairro: " << neighborhood << std::endl <<
                "Cidade: " << city << std::endl <<
                "CEP:    " << zip_code << std::endl;

        return string.str();

} // end get_adress_string
