...
int main(int argc, char** argv)
{
        ...
        Checking_account client("Carlos",
                                "0000-000X",
                                20000,
                                0);
        ...
        Savings_account savings_client_0("Carlos",
                                         "0000-000X",
                                         20000,
                                         1,
                                         10);

        Savings_account savings_client_1("Carlos",
                                         "0000-000X",
                                         20000,
                                         51,
                                         10);
        ...
        cout << "Client 1: " << savings_client_0.get_client_name() << endl;
        cout << "Account Number: " << savings_client_0.get_account_number() << endl;
        cout << "Balance: $" << savings_client_0.get_balance() << endl;

        cout << endl;

        cout << "Client Yield: " << savings_client_0.yield() << endl << endl;

        try
        {
                cout << "Client deposits $ -20.000" << endl;
                savings_client_0.deposit(-20000);
        ...
        cout << "Balance after deposit: $ " << savings_client_0.get_balance() << endl << endl;
        ...
        cout << "Balance after withdraw: $ " << savings_client_0.get_balance() << endl << endl;

        try
        {
                cout << "Client withdraw $ -40.000" << endl;
                savings_client_0.withdraw(-40000);
        ...
        {
                cout << "Client withdraw $ 10.000" << endl;
                savings_client_0.withdraw(10000);
        ...
        cout << "Client 1: " << savings_client_1.get_client_name() << endl;
        cout << "Account Number: " << savings_client_1.get_account_number() << endl;
        cout << "Balance: $" << savings_client_1.get_balance() << endl;

        cout << endl;

        cout << "Client Yield: " << savings_client_1.yield() << endl << endl;

        try
        {
                cout << "Client deposits $ -20.000" << endl;
                savings_client_1.deposit(-20000);
        ...
        cout << "Balance after deposit: $ " << savings_client_1.get_balance() << endl << endl;
        ...
        cout << "Balance after withdraw: $ " << savings_client_1.get_balance() << endl << endl;

        try
        {
                cout << "Client withdraw $ -40.000" << endl;
                savings_client_1.withdraw(-40000);
        ...
        {
                cout << "Client withdraw $ 10.000" << endl;
                savings_client_1.withdraw(10000);
